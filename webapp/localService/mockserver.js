    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServerInterface = {
            ...
            init: function (oOptionsParameter) {
                ...
                //En caso de no pasar parametro es un objeto vacio

                return new Promise(function (fnResolve, fnReject) {
                    var sManifestUrl = sap.ui.require.toUrl(_sAppPath + "manifest.json"),
                        oManifestModel = new JSONModel(sManifestUrl);

                    //Cuando tenemos el recurso ya cargado
                    oManifestModel.attachRequestCompleted(function () {
                        var oUriParameters = new UriParameters(window.location.href),
                            ...
                            // ensure there is a trailing slash (Asegurarnos de que hay una barra al final)
                        ...
                        if (!oMockServer) {
                            oMockServer = new MockServer({
                                //Pasamos la ruta completa de la app
                        ...
                        MockServer.config({
                            ...
                            //Primero evaluo las primeras dos oppciones, sino pone un delay de 500 ms
                        });
        ...
        //Hasta no devolverlo sige protegido
    });